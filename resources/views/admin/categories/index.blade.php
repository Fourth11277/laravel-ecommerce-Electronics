...
<div class="px-4 py-6 sm:px-0">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.categories.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-600">{{ $category->products_count }}</div>
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-6 py-4 text-center text-gray-600">No categories found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
